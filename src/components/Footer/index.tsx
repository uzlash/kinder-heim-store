...
const Footer = () => {
  ...
  const { isHeim, isKinder } = useBrand();
  ...
  const fillAccentColor = isHeim ? "fill-orange" : isKinder ? "fill-dark" : "fill-blue";
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                No 41 Trademore Avenue, Trademore Estate Phase 2, Lugbe, Abuja.
              </li>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className={`flex ease-out duration-200 ${hoverAccentColor}`}
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className={`ease-out duration-200 ${hoverAccentColor}`} href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                <a
                  className={`inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md ${bgAccentColor} ease-out duration-200 hover:bg-opacity-95`}
                  href="#"
                >
                  <svg
                    className="fill-current"
