...
const Header = () => {
  ...
  const beforeBgAccentColor = isHeim ? "before:bg-orange" : isKinder ? "before:bg-dark" : "before:bg-blue";

  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const data = await getAllCategories(brand || undefined);
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href={brandPrefix || "/"}>
              {isHeim ? (
                <span className="text-2xl font-bold font-serif text-orange">
                  HEIM
                </span>
              ) : isKinder ? (
                <span className="text-2xl font-bold font-serif text-dark">
                  Kinder
                </span>
              ) : (
                <Image
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className={isHeim ? "text-orange fill-current" : isKinder ? "text-dark fill-current" : "text-blue fill-current"}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
